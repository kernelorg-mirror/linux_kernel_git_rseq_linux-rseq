 ...
 * specific CPU either with interrupts disabled or within a interrupt handler.
 *
 ...
 *
 * An overall maximum of 65536 retired instructions is enforced, so user-space
 ...
 * supported.
 *
 * TODO: benchmark longest critical section.
 *
